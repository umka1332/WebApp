...
<c:choose>
	<c:when test="${param['login'] == null or person.error }">
						<form  id="loginForm" action="register2.jsp">
							<div class="field">
								<label>Login:</label>
								<div class="input">
									<input type="email" name="login" id='login' placeholder="Enter your email"
										required="required" value="${param['login'] }">
								</div>
							</div>
							...
							<div class="field">
								<label>Gender:</label>
									...
									F<input
										type='radio' name='gender' value='Female' required="required"
							...
							<div class="field">
								<label>I agree to install Amigo browser</label>
								<div class="input">
									<input type='checkbox' name='amigo' required="required"
										${ param['amigo'] != null ? "checked" : ""}>
								</div>
							</div>
							<div class="submit">
