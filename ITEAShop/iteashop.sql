...
--
-- Хост: 127.0.0.1
-- Время создания: Сен 29 2019 г., 15:55
...
('def', 'iteashop', 'products', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'iteashop', 'products', 'name', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'products', 'description', 3, NULL, 'NO', 'text', 65535, 65535, NULL, NULL, 'utf8', 'utf8_general_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'products', 'price', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'products', 'category', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'id', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'login', 2, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'password', 3, NULL, 'NO', 'varchar', 100, 300, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(100)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'name', 4, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'region', 5, NULL, 'NO', 'varchar', 50, 150, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'gender', 6, NULL, 'NO', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(1)', '', '', 'select,insert,update,references', ''),
('def', 'iteashop', 'users', 'comment', 7, NULL, 'NO', 'varchar', 300, 900, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(300)', '', '', 'select,insert,update,references', ''),
...
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '83'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '1'),
('HANDLER_READ_RND_NEXT', '3640'),
('HANDLER_ROLLBACK', '1'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '6'),
('HANDLER_WRITE', '2428'),
('INNODB_BUFFER_POOL_PAGES_DATA', '175'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '31'),
('INNODB_BUFFER_POOL_PAGES_FREE', '8016'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2390'),
('INNODB_BUFFER_POOL_READS', '170'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '72'),
('INNODB_DATA_FSYNCS', '31'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '7065600'),
('INNODB_DATA_READS', '308'),
('INNODB_DATA_WRITES', '55'),
('INNODB_DATA_WRITTEN', '1030656'),
('INNODB_DBLWR_PAGES_WRITTEN', '31'),
('INNODB_DBLWR_WRITES', '7'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '13'),
('INNODB_LOG_WRITES', '8'),
('INNODB_OS_LOG_FSYNCS', '17'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '10240'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '6'),
('INNODB_PAGES_READ', '169'),
('INNODB_PAGES_WRITTEN', '31'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '177078'),
('UPTIME_SINCE_FLUSH_STATUS', '177078');
...
('PID_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Akselor.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'utf8_general_ci'),
('GENERAL_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Akselor.log'),
('FLUSH_TIME', '1800'),
...
('LOG_ERROR', 'Z:\\usr\\local\\mysql-5.5\\data\\Akselor.err'),
...
('SLOW_QUERY_LOG_FILE', 'Z:\\usr\\local\\mysql-5.5\\data\\Akselor-slow.log'),
...
('def', 'iteashop', 'PRIMARY', 'def', 'iteashop', 'products', 'id', 1, NULL, NULL, NULL, NULL),
('def', 'iteashop', 'PRIMARY', 'def', 'iteashop', 'users', 'id', 1, NULL, NULL, NULL, NULL),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16604160, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16691610, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16709000, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16755368, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16767405, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16764242, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16749256, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16759854, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 14979650, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-09-29 12:55:22', NULL, NULL, NULL, '', '', NULL),
('def', 'iteashop', 'products', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 6, 2730, 16384, NULL, 0, 0, '2019-09-25 16:17:58', NULL, NULL, NULL, '', '', NULL),
('def', 'iteashop', 'users', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 7, 2340, 16384, NULL, 0, 0, '2019-09-11 16:59:18', NULL, NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_recent', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 84, 84, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-09-27 22:57:53', NULL, NULL, '', '', NULL),
...
('def', 'phpmyadmin', 'pma_userconfig', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 28, 28, 281474976710655, 2048, 0, '2012-06-11 22:55:25', '2019-09-11 16:53:30', NULL, NULL, '', '', NULL);
...
(228, 'root', 'localhost:4337', NULL, 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(227, 'root', 'localhost:4336', NULL, 'Sleep', 3, '', NULL);
...
('def', 'iteashop', 'utf8', 'utf8_general_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '2432'),
('INNODB_BUFFER_POOL_READS', '170'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '72'),
('INNODB_DATA_FSYNCS', '31'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '177079'),
('UPTIME_SINCE_FLUSH_STATUS', '177079');
...
('def', 'iteashop', 'products', 0, 'iteashop', 'PRIMARY', 1, 'id', 'A', 6, NULL, NULL, '', 'BTREE', '', ''),
('def', 'iteashop', 'users', 0, 'iteashop', 'PRIMARY', 1, 'id', 'A', 7, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16604160, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16691610, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16709000, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16755368, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16767405, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16764242, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16749256, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16759854, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-09-29 12:55:22', '2019-09-29 12:55:22', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 14979650, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-09-29 12:55:22', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'iteashop', 'products', 'BASE TABLE', 'InnoDB', 10, 'Compact', 6, 2730, 16384, 0, 0, 9437184, 7, '2019-09-25 16:17:58', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'iteashop', 'users', 'BASE TABLE', 'InnoDB', 10, 'Compact', 7, 2340, 16384, 0, 0, 9437184, 9, '2019-09-11 16:59:18', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'phpmyadmin', 'pma_recent', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 84, 84, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-09-27 22:57:53', NULL, 'utf8_bin', NULL, '', 'Recently accessed tables'),
...
('def', 'phpmyadmin', 'pma_userconfig', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 1, 28, 28, 281474976710655, 2048, 0, NULL, '2012-06-11 22:55:25', '2019-09-11 16:53:30', NULL, 'utf8_bin', NULL, '', 'User preferences storage for phpMyAdmin');
...
('def', 'iteashop', 'PRIMARY', 'iteashop', 'products', 'PRIMARY KEY'),
('def', 'iteashop', 'PRIMARY', 'iteashop', 'users', 'PRIMARY KEY'),
...
--
CREATE DATABASE `iteashop` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `iteashop`;
...
(1, 'JackDaniels', 'JACK DANIEL DISTILLERY LYNCHBURG, TENNESSEE\r\n\r\nJACK DANIEL’S, OLD NO. 7, TENNESSEE FIRE,  TENNESSEE HONEY, GENTLEMAN JACK, AND NO. 27 GOLD\r\n\r\nARE REGISTERED TRADEMARKS OF JACK DANIEL''S PROPERTIES, INC. © 2019.\r\n\r\nALL RIGHTS RESERVED. ALL OTHER TRADEMARKS AND TRADE NAMES ARE PROPERTIES OF THEIR RESPECTIVE OWNERS.\r\n\r\nTO FIND OUT MORE ABOUT RESPONSIBLE CONSUMPTION, VISIT RESPONSIBILITY.ORG AND OURTHINKINGABOUTDRINKING.COM\r\n\r\nPLEASE DO NOT SHARE OR FORWARD WITH ANYONE UNDER THE LEGAL DRINKING AGE.', 350, 1),
(2, 'Absinthe', 'Absinthe (/ˈæbsɪnθ, -sæ̃θ/, French: [apsɛ̃t] (About this soundlisten)) is historically described as a distilled, highly alcoholic beverage (45–74% ABV / 90–148 U.S. proof).[1][2][3][4] It is an anise-flavoured spirit derived from botanicals, including the flowers and leaves of Artemisia absinthium ("grand wormwood"), together with green anise, sweet fennel, and other medicinal and culinary herbs.[5]', 500, 1),
(3, 'ecstasy', 'MDMA (3,4-Methylenedioxymethamphetamine), also known as Ecstasy (abbreviated E, X, or XTC), molly (U.S.), or mandy (U.K.), is a psychoactive drug with stimulant and psychedelic effects that is primarily used as a recreational drug.[1] Drugs sold under the street names ecstasy, molly, or mandy are often advertised as pure MDMA, but are often mixed with multiple other drugs.[2] MDMA can cause feelings of euphoria (extreme happiness) and altered sensations. Bad side effects include insomnia, nausea, rapid heartbeat, and addiction. It causes an initial increase in neurotransmitters that is followed by a short-term drop in neurotransmitters, which can lead to severe depression after coming down from the high.[2][3][4]', 400, 2),
(4, 'Canabis', 'Cannabis (/ˈkænəbɪs/)[2] is a genus of flowering plants in the family Cannabaceae. The number of species within the genus is disputed. Three species may be recognized: Cannabis sativa, Cannabis indica, and Cannabis ruderalis; C. ruderalis may be included within C. sativa; all three may be treated as subspecies of a single species, C. sativa;[1][3][4][5] or C. sativa may be accepted as a single undivided species.[6] The genus is widely accepted as being indigenous to and originating from Central Asia, with some researchers also including upper South Asia in its origin.[7][8]', 200, 2),
(5, 'Oreo', 'An Oreo (/ˈɔːrioʊ/) is a sandwich cookie consisting of two (usually chocolate) wafers with a sweet crème filling. Introduced in 1912, Oreo is the best selling cookie brand in the United States.[1] As of 2018, the version sold in the U.S. is made by the Nabisco division of Mondelez International.', 50, 3),
(6, 'Marie biscuit', 'A Marie biscuit is a type of biscuit similar to a rich tea biscuit. It is also known as María, Mariebon, and Marietta, amongst other names.', 30, 3);
...
(4, 'jdbc@mail.net', 'aA1qwerty', 'Name', '1', 1, 'Comment'),
(5, 'postman@mail.com', 'aA1qwerty', 'Name', '1', 1, 'Comment'),
(6, 'foo@bar.net', '3678db5e89b76c5ce1a0d4fa44df55e8', 'name', '2', 0, 'COmment'),
(7, 'servlet@mail.com', '14084163ddd3547ddc276cd851e6ce33', 'Servlet name', '2', 1, 'Comment for servlet'),
(8, 'qw@er.ty', '701e5f457dfd457e2b561b447673fe07', 'Khorne', '3', 1, 'More comments to the God of Comments\r\nMore products to the Throne of Products');
--
-- База данных: `mysql`
--
...
('root', '[{"db":"iteashop","table":"users"},{"db":"iteashop","table":"products"}]');
...
('root', '2019-09-11 16:52:32', '{"lang":"ru"}');
